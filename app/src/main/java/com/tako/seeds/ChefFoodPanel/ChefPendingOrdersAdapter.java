package com.tako.seeds.ChefFoodPanel;
...
import com.tako.seeds.SendNotification.APIService;
import com.tako.seeds.SendNotification.Client;
import com.tako.seeds.SendNotification.Data;
import com.tako.seeds.SendNotification.MyResponse;
import com.tako.seeds.SendNotification.NotificationSender;
...
public class ChefPendingOrdersAdapter extends RecyclerView.Adapter<ChefPendingOrdersAdapter.ViewHolder> {
    ...
    public void onBindViewHolder(@NonNull ViewHolder holder, int position) {
        ...
        holder.grandtotalprice.setText("GrandTotal: PH " + chefPendingOrders1.getGrandTotalPrice());
